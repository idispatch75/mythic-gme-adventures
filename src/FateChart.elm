...
type alias FateChart =
    List ChaosFactorOutcomeProbabilities
...
determineOutcome chartType probability chaosFactor dieRoll =
    let
        chaosFactorInt : Int
        chaosFactorInt =
            ChaosFactor.toInt chaosFactor

        outcomeProbability : OutcomeProbability
        outcomeProbability =
            ListX.find (\x -> chaosFactorInt >= x.min && chaosFactorInt <= x.max) (chartFromType chartType)
...
fallbackChaosFactor =
    ChaosFactorOutcomeProbabilities 1
        9
...
fateChartStandard =
    ...
    , ChaosFactorOutcomeProbabilities 2
        2
        [ outcomeProbabilityForThreshold 65
        , outcomeProbabilityForThreshold 50
        , outcomeProbabilityForThreshold 35
    ...
    , ChaosFactorOutcomeProbabilities 3
        3
        [ outcomeProbabilityForThreshold 75
        , outcomeProbabilityForThreshold 65
        , outcomeProbabilityForThreshold 50
    ...
    , ChaosFactorOutcomeProbabilities 4
        4
        [ outcomeProbabilityForThreshold 85
        , outcomeProbabilityForThreshold 75
        , outcomeProbabilityForThreshold 65
    ...
    , ChaosFactorOutcomeProbabilities 5
        5
        [ outcomeProbabilityForThreshold 90
        , outcomeProbabilityForThreshold 85
        , outcomeProbabilityForThreshold 75
    ...
    , ChaosFactorOutcomeProbabilities 6
        6
    ...
    , ChaosFactorOutcomeProbabilities 7
        7
    ...
    , ChaosFactorOutcomeProbabilities 8
        8
        [ outcomeProbabilityForThreshold 99
        , outcomeProbabilityForThreshold 99
        , outcomeProbabilityForThreshold 95
    ...
    , ChaosFactorOutcomeProbabilities 9
        9
        [ outcomeProbabilityForThreshold 99
        , outcomeProbabilityForThreshold 99
        , outcomeProbabilityForThreshold 99
